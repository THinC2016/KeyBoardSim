...
/**
 * Created by jacobdurrah on 2/16/16.
 */
public class Bundle_Keys {
    //values for FP and CL
    public final static String BUNDLE_Waypoint_KEY = "WaypointValue";
    public final static String BUNDLE_Checklist_KEY = "CheckListValues";
